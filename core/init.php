...
//免费版表单增加按钮链接到付费测算
$GLOBALS['config']['ff_url']['bazijp']="http://sm.cmbbn.com/?ac=bazijp";
$GLOBALS['config']['ff_url']['bazijp_t']="付费测算";
$GLOBALS['config']['ff_url']['hehun']="http://sm.cmbbn.com/?ac=hehun";
$GLOBALS['config']['ff_url']['hehun_t']="付费测算";
$GLOBALS['config']['ff_url']['xmpd']="http://sm.cmbbn.com/?ac=xmpd";
$GLOBALS['config']['ff_url']['xmpd_t']="付费测算";
$GLOBALS['config']['ff_url']['ffqm']="http://sm.cmbbn.com/?ac=ffqm";
$GLOBALS['config']['ff_url']['ffqm_t']="付费测算";
$GLOBALS['config']['ff_url']['xmfx']="http://sm.cmbbn.com/?ac=xmfx";
$GLOBALS['config']['ff_url']['xmfx_t']="付费测算";
$GLOBALS['config']['ff_url']['bazi']="http://sm.cmbbn.com/?ac=bazi";
$GLOBALS['config']['ff_url']['bazi_t']="付费测算";
$GLOBALS['config']['ff_url']['hmjx']="http://sm.cmbbn.com/?ac=hmjx";
