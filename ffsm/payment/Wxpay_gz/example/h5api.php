...
// $input->SetGoods_tag("test");
$input->SetNotify_url("http://sm.cmbbn.com/payment/Wxpay_gz/example/h5pay_back.php");//通知地址
...
header('Location: '.$order['mweb_url'].'&redirect_url='.urlencode('http://sm.cmbbn.com/?ac='.$ac.'&oid='.$params['out_trade_no'].'&token='.base64_encode(md5($params['out_trade_no']))));
die;
$payurl = $order['mweb_url'].'&redirect_url='.urlencode('http://sm.cmbbn.com/?ac='.$ac.'&oid='.$params['out_trade_no'].'&token='.base64_encode(md5($params['out_trade_no'])));

$callbackurl = 'http://sm.cmbbn.com/?ac='.$ac.'&oid='.$params['out_trade_no'].'&token='.base64_encode(md5($params['out_trade_no']));
