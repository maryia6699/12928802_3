<?php /* Smarty version 2.6.25, created on 2019-12-26 16:13:07
         compiled from ffsm/ziwei_order.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
...
<div class="orders_num J_testFixedShow">
	订单编号：<span class="red"><?php echo $this->_tpl_vars['oid']; ?>
</span>
</div>
<div class="public_box border1">
	<div class="base_info">
		<p class="base_info_name">姓名：&nbsp;<?php echo $this->_tpl_vars['data']['username']; ?>
 (<?php if ($this->_tpl_vars['data']['gender'] == 1): ?>男<?php else: ?>女<?php endif; ?>)</p>
		<p>阳历生日：&nbsp;<?php echo $this->_tpl_vars['data']['y']; ?>
	...
	<div class="zw_pay_wrapper">
		...
		<div class="zw_pay_chose">
			<p class="zpc_price_bonds">
				优惠价：<span>￥<?php echo $this->_tpl_vars['money']; ?>
</span>
			</p>
	...
	<div class="ziwei_disc">
		<div class="zd_box">
			<div class="zd_con">
				...
				<p>
					阳历：<?php echo $this->_tpl_vars['data']['y']; ?>
年<?php echo $this->_tpl_vars['data']['m']; ?>
月<?php echo $this->_tpl_vars['data']['d']; ?>
日
				</p>
				<p>
					阴历：<?php echo $this->_tpl_vars['data']['lDate']; ?>

				</p>
                <p>
                	命主:<?php echo $this->_tpl_vars['return']['mingzhum']; ?>
&nbsp; 身主:<?php echo $this->_tpl_vars['return']['shenzhum']; ?>
			...
			<div class="zd_block zd_block_1">
				...
				<?php echo $this->_tpl_vars['return']['pan']['5']; ?>

                
			</div>
            
			<div class="zd_block zd_block_2">
				<?php echo $this->_tpl_vars['return']['pan']['6']; ?>

			</div>
			<div class="zd_block zd_block_3">
				<?php echo $this->_tpl_vars['return']['pan']['7']; ?>

			</div>
			<div class="zd_block zd_block_4">
				<?php echo $this->_tpl_vars['return']['pan']['8']; ?>

			</div>
			<div class="zd_block zd_block_5">
				<?php echo $this->_tpl_vars['return']['pan']['9']; ?>

			</div>
			<div class="zd_block zd_block_6">
				<?php echo $this->_tpl_vars['return']['pan']['10']; ?>

			</div>
			<div class="zd_block zd_block_7">
				<?php echo $this->_tpl_vars['return']['pan']['11']; ?>

			</div>
			<div class="zd_block zd_block_8">
				<?php echo $this->_tpl_vars['return']['pan']['0']; ?>

			</div>
			<div class="zd_block zd_block_9">
				<?php echo $this->_tpl_vars['return']['pan']['1']; ?>

			</div>
			<div class="zd_block zd_block_10">
				<?php echo $this->_tpl_vars['return']['pan']['2']; ?>

			</div>
			<div class="zd_block zd_block_11">
				<?php echo $this->_tpl_vars['return']['pan']['3']; ?>

			</div>
			<div class="zd_block zd_block_12">
				<?php echo $this->_tpl_vars['return']['pan']['4']; ?>
