<?php /* Smarty version 2.6.25, created on 2019-12-12 13:58:56
         compiled from ffsm/gsqm_order.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
<title>公司在线起名,公司在线取名,新公司测名起名-深度网</title>
...
<div class="container pay" style="padding-bottom:0px;">
  <div class="wrap">
    <div class="person">
      <div class="infos">
        <p>公司名称：<?php echo $this->_tpl_vars['names']['name']; ?>
</p>
        <p>老板姓名：<?php echo $this->_tpl_vars['names']['username']; ?>
</p>
        <p>你的性别：<?php if ($this->_tpl_vars['names']['gender'] == 1): ?>男<?php else: ?>女<?php endif; ?></p>
