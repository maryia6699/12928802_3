<?php /* Smarty version 2.6.25, created on 2020-04-20 15:17:41
         compiled from ffsm/xydd_order.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
 <head> 
  <meta charset="utf-8" /> 
      ...
      <div class="banner">
       <div class="lantern">
        <div class="lantern-on">
         <img src="/statics/ffsm/xydd/images/light/<?php echo $this->_tpl_vars['xyd_data']['1']; ?>
" alt="" />
        </div>
       </div>
       <div class="lantern-desc">
        <img src="/statics/ffsm/xydd/images/xuyuandiandeng/<?php echo $this->_tpl_vars['xyd_data']['1']; ?>
" alt="" />
       </div>
      </div>
      ...
      <section>
	   <form class="J_ajaxForm J_testFixedTop" id="submit1" action="/?ac=xydd&lantern_id=<?php echo $this->_tpl_vars['lantern_id']; ?>
" name="login" method="post" onSubmit="return checkForm();">
      ...
      <div class="main-content mai_d">
       ...
       <?php echo $this->_tpl_vars['xyd_data']['2']; ?>
